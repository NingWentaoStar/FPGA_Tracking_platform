...
wire [11:0]    vcount_center/*synthesis syn_keep=1*/;
wire [11:0]    hcount_center/*synthesis syn_keep=1*/;
wire [23:0]VGA_rgb;
wire       VGA_hsync;
wire       VGA_vsync;
wire       VGA_de;
ISP ISP(
   ...
   .hcount_center        (hcount_center)
        ...
        wire [14:0]x_high_us/*synthesis syn_keep=1*/;
        wire [14:0]y_high_us/*synthesis syn_keep=1*/;
        wire [14:0]x_ct_us/*synthesis syn_keep=1*/;
        wire [14:0]y_ct_us/*synthesis syn_keep=1*/;
...
top_steering pwm(
        ...
        .x                (hcount_center),
        .y                (vcount_center),
        .PWMsteering1     (PWMsteering1),
        .PWMsteering2     (PWMsteering2),
